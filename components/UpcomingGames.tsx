                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mb-3 md:hidden">
                                        <div className="bg-white/[0.02] px-2.5 py-1 rounded-md text-[10px] font-medium text-slate-300 border border-white/[0.05] flex items-center gap-1.5">
                                    ...
                                    <div className="flex-1 flex items-center justify-between md:justify-center gap-2 md:gap-4 mb-3 md:mb-0">
                                        ...
                                        <div className="flex-shrink-0 px-3 py-1 bg-black/40 border border-white/[0.05] rounded-lg shadow-inner">
