          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <nav className="flex bg-white/[0.02] p-1 rounded-xl border border-white/5 shadow-inner">
                ...
                <button onClick={() => setActiveMainTab('nba')} className={`px-4 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest transition-all duration-300 ${activeMainTab === 'nba' ? 'bg-orange-500 text-white shadow-2xl scale-105' : 'text-white/30 hover:text-orange-500'}`}>NBA PRO</button>
              </nav>
              {(isLoggedIn || isAdminView) && (
