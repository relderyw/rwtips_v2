...
const commonTeams = [
    ...
    'Real Madrid', 'Barcelona', 'FC Bayern', 'Man City', 'Man Utd', 'Manchester United', 'Liverpool', 'PSG', 'Juventus', 'Arsenal', 'Chelsea',
    ...
    'Noruega', 'Norway', 'Racing Club', 'River Plate', 'Boca Juniors', 'Athletic Club MG'
];
